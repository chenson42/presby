...
knows what exists without re-reconning. **Version `0.14.0` · surveyed 2026-08-26.**
...
- Portal chrome — org logo (`OrgWordmark`, links to `/site/<slug>`) replaces the platform wordmark in the header inside `/o/<slug>`, plus a persistent flag-filtered menu row. Gated `org_portal.chrome_v2` + `org_portal.feedback` (both seeded off). `src/app/(org)/o/[slug]/layout.tsx`, `portal-nav.tsx`, `docs/work-log/2026-08-25-portal-chrome.md`
