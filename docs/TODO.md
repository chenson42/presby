...
- [ ] **P0.5 — design foundation + brand architecture** — Phases 1–3 complete; **Phase 4 in progress: `0.1`, `a1`, `0.2`, `a2`–`a5` shipped; `a6` (credential-surface sweep, auth e2e gate) complete**. Next: `a7` (member + shared sweep), then `a8` flips C2 on. Slices b–e (generator, storage+emission, church editor, type pairings) have **no Phase 2 yet** — the architect reviewed only 0 and a. — `docs/work-log/2026-08-19-brand-foundation.md`
