...
CREATE TABLE "memberships" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "memberships_person_org_key" UNIQUE("person_id","organization_id"),
...
ALTER TABLE "memberships" ADD CONSTRAINT "memberships_household_fk" FOREIGN KEY ("household_id","organization_id") REFERENCES "public"."households"("id","organization_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "background_checks" ADD CONSTRAINT "background_checks_person_fk" FOREIGN KEY ("person_id","organization_id") REFERENCES "public"."memberships"("person_id","organization_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "follow_ups" ADD CONSTRAINT "follow_ups_person_fk" FOREIGN KEY ("person_id","organization_id") REFERENCES "public"."memberships"("person_id","organization_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "follow_ups" ADD CONSTRAINT "follow_ups_assignee_fk" FOREIGN KEY ("assigned_to_person_id","organization_id") REFERENCES "public"."memberships"("person_id","organization_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "person_medical" ADD CONSTRAINT "person_medical_person_fk" FOREIGN KEY ("person_id","organization_id") REFERENCES "public"."memberships"("person_id","organization_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "person_milestones" ADD CONSTRAINT "person_milestones_person_fk" FOREIGN KEY ("person_id","organization_id") REFERENCES "public"."memberships"("person_id","organization_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "person_milestones" ADD CONSTRAINT "person_milestones_officiant_fk" FOREIGN KEY ("officiant_person_id","organization_id") REFERENCES "public"."memberships"("person_id","organization_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "person_notes" ADD CONSTRAINT "person_notes_person_fk" FOREIGN KEY ("person_id","organization_id") REFERENCES "public"."memberships"("person_id","organization_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "person_tags" ADD CONSTRAINT "person_tags_person_fk" FOREIGN KEY ("person_id","organization_id") REFERENCES "public"."memberships"("person_id","organization_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "person_talents" ADD CONSTRAINT "person_talents_person_fk" FOREIGN KEY ("person_id","organization_id") REFERENCES "public"."memberships"("person_id","organization_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "roll_actions" ADD CONSTRAINT "roll_actions_person_fk" FOREIGN KEY ("person_id","organization_id") REFERENCES "public"."memberships"("person_id","organization_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "officer_terms" ADD CONSTRAINT "officer_terms_person_fk" FOREIGN KEY ("person_id","organization_id") REFERENCES "public"."memberships"("person_id","organization_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "ordinations" ADD CONSTRAINT "ordinations_person_fk" FOREIGN KEY ("person_id","organization_id") REFERENCES "public"."memberships"("person_id","organization_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "group_memberships" ADD CONSTRAINT "group_memberships_person_fk" FOREIGN KEY ("person_id","organization_id") REFERENCES "public"."memberships"("person_id","organization_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "role_grants" ADD CONSTRAINT "role_grants_person_fk" FOREIGN KEY ("person_id","organization_id") REFERENCES "public"."memberships"("person_id","organization_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "consents" ADD CONSTRAINT "consents_person_fk" FOREIGN KEY ("person_id","organization_id") REFERENCES "public"."memberships"("person_id","organization_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "consents" ADD CONSTRAINT "consents_guardian_fk" FOREIGN KEY ("granted_by_person_id","organization_id") REFERENCES "public"."memberships"("person_id","organization_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "person_demographics" ADD CONSTRAINT "person_demographics_person_fk" FOREIGN KEY ("person_id","organization_id") REFERENCES "public"."memberships"("person_id","organization_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "person_disabilities" ADD CONSTRAINT "person_disabilities_person_fk" FOREIGN KEY ("person_id","organization_id") REFERENCES "public"."memberships"("person_id","organization_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "person_privacy" ADD CONSTRAINT "person_privacy_person_fk" FOREIGN KEY ("person_id","organization_id") REFERENCES "public"."memberships"("person_id","organization_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "addresses_person_idx" ON "addresses" USING btree ("person_id");--> statement-breakpoint
