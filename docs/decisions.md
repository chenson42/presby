...
**DECISION-142: Track B's brand-vocabulary widening is withdrawn — `--card`/`--popover`/`--muted`/`--secondary`/`--border`/`--input` stay `platform`, `--radius` stays `platform` per DECISION-048, and `BRAND_TOKEN_VERSION` does not move.** (2026-09-25, architect Phase 2, `docs/work-log/2026-09-25-brand-visual-parity.md`; pending the operator's confirmation — see the work-log.)
...
**Status:** Resolved · **Date:** 2026-09-24 · **Feature:** `2026-09-24-lifecycle-affiliation-returns` (Phase 3, sixth loop-back)
